...
public abstract class LumpIndices {
    ...
    public static final int NUM_LUMPS = 64;
    ...
    public static String lumpName(int lumpIndex) {
        assert lumpIndex >= 0 && lumpIndex < NUM_LUMPS;
        return LUMP_NAMES[lumpIndex];
    }

    public static int lumpStructSize(int lumpIndex) {
        assert lumpIndex >= 0 && lumpIndex < NUM_LUMPS;
        return LUMP_SIZES[lumpIndex];
    }
}
